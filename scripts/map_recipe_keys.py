...
def main() -> None:
    ...
    def find_key_contains(*needles: str):
    ...
    # Leather
    mapping["LEATHER:light"] = find_key_contains("leather", "light")
    mapping["LEATHER:medium"] = find_key_contains("leather", "medium")
    mapping["LEATHER:heavy"] = find_key_contains("leather", "heavy")
    mapping["LEATHER:storm"] = find_key_contains("leather", "storm")
    mapping["LEATHER:prism"] = find_key_contains("leather", "prism")
